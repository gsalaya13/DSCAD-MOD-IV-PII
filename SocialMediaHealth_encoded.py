...
def user_input_features():
  # Entrada
  age = st.number_input('Edad en años:', min_value=0, max_value=24, value = 1, step = 1)
  daily_social_media_hours = st.number_input('Tiempo diario en redes sociales:', min_value=0, max_value=24, value = 0, step = 1)
  sleep_hours = st.number_input('Tiempo de sueño al día:', min_value=0, max_value=24, value = 5, step = 1)
  screen_time_before_sleep = st.number_input('Tiempo en pantalla antes de dormir en horas:',min_value=0, max_value=24, value = 2, step = 1)
  academic_performance = st.number_input('Desempeño escolar del 1 al 10:', min_value=0, max_value=10, value = 0, step = 1)
  physical_activity = st.number_input('Actividad física en horas:',min_value=0, max_value=10, value = 1, step = 1)
  stress_level = st.number_input('Nivel de estrés del 1 al 10:', min_value=0, max_value=10, value = 5, step = 1)
  anxiety_level = st.number_input('Nivel de ansiedad del 1 al 10:', min_value=0, max_value=10, value = 5, step = 1)
  addiction_level = st.number_input('Nivel de adición del 1 al 10:', min_value=0, max_value=10, value = 5, step = 1)
...
socmedhea =  pd.read_csv('Teen_Mental_Health_Dataset_encoded.csv', encoding='latin-1')
